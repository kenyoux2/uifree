...
function Flux:Window(text, bottom,mainclr)
	...
	TabHold.Size = UDim2.new(0, 205, 0, 300)
	...
	MainFrame:TweenSize(UDim2.new(0, 500, 0, 300), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .6, true)
	...
	function Flux:Notification(desc,buttontitle)
		...
		NotificationBase.Size = UDim2.new(0, 500, 0, 300)
